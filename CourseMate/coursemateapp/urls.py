...
urlpatterns = [
    ...
    path('teacher/<slug:course_name_slug>/register-student', views.regstudent, name='regstudent'), #implement properly
    ...
    path('teacher/<slug:course_name_slug>/edit-course-cont', views.editcoursecont, name='editcoursecont'), #test, add more functionality
    path('teacher/review/<slug:review_ID_slug>', views.teacherreview, name='teacherreview'),  #test, fix models
    path('teacher/register-course', views.regcourse, name='regcourse'), #test, fix field Error
